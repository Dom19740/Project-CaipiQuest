  ...
  const fruitSVGs: { [key: string]: JSX.Element } = {
    lime: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <circle cx="12" cy="12" r="10" fill="#A7D129"/>
        <path d="M12 2C12 2 10 4 10 5C10 6 12 8 12 8C12 8 14 6 14 5C14 4 12 2 12 2Z" fill="#6B8E23"/>
        <path d="M12 12C12 12 10 14 10 15C10 16 12 18 12 18C12 18 14 16 14 15C14 14 12 12 12 12Z" fill="#6B8E23"/>
        <path d="M6 12C6 12 4 14 4 15C4 16 6 18 6 18C6 18 8 16 8 15C8 14 6 12 6 12Z" fill="#6B8E23"/>
        <path d="M18 12C18 12 16 14 16 15C16 16 18 18 18 18C18 18 20 16 20 15C20 14 18 12 18 12Z" fill="#6B8E23"/>
      </svg>
    ),
    passionfruit: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <circle cx="12" cy="12" r="10" fill="#9C27B0"/>
        <path d="M12 2C12 2 10 4 10 5C10 6 12 8 12 8C12 8 14 6 14 5C14 4 12 2 12 2Z" fill="#6A1B9A"/>
        <circle cx="12" cy="12" r="4" fill="#E0BBE4"/>
        <circle cx="10" cy="10" r="1" fill="#8E24AA"/>
        <circle cx="14" cy="14" r="1" fill="#8E24AA"/>
      </svg>
    ),
    lemon: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
